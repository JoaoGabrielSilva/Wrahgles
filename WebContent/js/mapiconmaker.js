...
function IconLoucaliza(url, icone) {
    this.url = url;
    this.icone = icone;
}
...
MapIconMaker.createLabeledMarkerIcon = function (opts) {
  ...
  //var icon = new GIcon(G_DEFAULT_ICON);
  var size = (addStar) ? new google.maps.Size(23, 39) : new google.maps.Size(21, 34);
  var icon = new IconLoucaliza(iconUrl + "&ext=.png", new google.maps.MarkerImage(iconUrl + "&ext=.png", size));
