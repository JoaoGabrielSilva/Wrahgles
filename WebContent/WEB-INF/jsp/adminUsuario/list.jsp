...
var optPagination = {callback: pageselectCallback, items_per_page:20,
        ...
        function pageselectCallback(page_index, jq){
    		...
    		if(window.location.pathname.search("Wrahgles") != -1) {
             ...
             var url = contexto + '/admin/usuario/pagination/'+items_per_page+'/'+page_index;
    	...
    	$(document).ready(function(){
			$("#paginacao").pagination($('#qtdUsuarios').val(), optPagination);
		});
...
<input type="hidden" id="qtdUsuario" value="${qtdUsuario}"/>
