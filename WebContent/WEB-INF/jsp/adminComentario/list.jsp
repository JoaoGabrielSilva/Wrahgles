...
var optPagination = {callback: pageselectCallback, items_per_page:20,
        ...
        function pageselectCallback(page_index, jq){
    		...
    		if(window.location.pathname.search("Wrahgles") != -1) {
             ...
             var url = contexto + '/admin/comentario/pagination/'+items_per_page+'/'+page_index;
    	...
    	$(document).ready(function(){
			$("#paginacao").pagination($('#qtdComentarios').val(), optPagination);
		});
...
<input type="hidden" id="qtdComentarios" value="${qtsComentarios}">
  ...
  <tr>
    <td align="left" height="50px"> 
        ...
        <c:if test="${submenu eq 'todas'}">
           <td width="130" align="center">
            ...
            <td width="130" align="center">
             ...
             <a href="<c:url value="/admin/comentario/listAprovado"/>">Aprovadas</a>
           </td>
           ...
           <td width="130" align="center">
             <span class="label"></span>
             <a href="<c:url value="/admin/comentario/listPendente"/>">Pendentes</a>
           </td>
        </c:if>
        ...
        <c:if test="${submenu eq 'aprovado'}">
         <td width="130" align="center">
           <span class="label">
            <a href="<c:url value="/admin/comentario/list" />">Todas</a>
           </span>
         </td>
