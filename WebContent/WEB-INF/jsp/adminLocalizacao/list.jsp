...
var optPagination = {callback: pageselectCallback, items_per_page:20,
        ...
        function pageselectCallback(page_index, jq){
    		...
    		if(window.location.pathname.search("Wrahgles") != -1) {
             ...
             var url = contexto + '/admin/localizacao/pagination/'+items_per_page+'/'+page_index;
  ...
  <tr>
     ...
     <c:if test="${submenu eq 'todas'}">
       ...
       <td width="10" align="center"><span class="label">|</span></td>
        ...
        <td width="130" align="center">
         <span class="label">
         <a href="<c:url value="/admin/localizacao/listAprovado" />">Aprovadas</a>
         </span>
        </td>
        ...
        <td width="10" align="center"><span class="label">|</span></td>
         ...
         <td width="130" align="center">
         <span class="label">
         <a href="<c:url value="/admin/localizacao/listPendente" />">Pendentes</a>
         </span>
        </td>
     </c:if>
